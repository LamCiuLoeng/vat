...
<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" >
    <li  class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active" ><a href="#tabs-0">MCN</a></li>
</ul>
<div id="tabs-0" class="ui-tabs-panel ui-widget-content ui-corner-bottom" >
    <div class="box2">
        <div class="title1"><div class="toggle_down"></div>Search MCN Result</div>
        <div class="box4">
            <table class="gridTable" cellpadding="0" cellspacing="0" border="0">
                <thead>
                    <tr>
                        <td colspan="100" style="border-right:0px;border-bottom:0px">
                            <div class="toolbar">
                                <div class="l">
								    <form action="/cost/save_to_nthead" id="_form" method="post">
								    	...
								    	<input type="submit" class="btn" value="Save as CCN" id="btn_save_as_msi" onclick="ajaxForm('#_form','Save Success!','0','0',saveAllToThead(),'save_to_cost')" />
                ...
                <tbody>
                    ...
                    <tr id="tr1_${i.id}">
                        <td width="20px" class="head"><input type="checkbox" class="cboxClass" value="${i.id}$${b(i.customer_code)|n}" onclick="selectOne()" /></td>
                        <td title="Ref" ><a href="javascript:viewChead('${i.id}','${i.ref}')">${b(i.ref)|n}</a></td>
                        <td title="MSI/MSO Ref" ><a href="javascript:viewThead('${i.t_head_id}', '${i.thead_ref}')">${b(i.thead_ref)|n}</a></td>
                        <td title="MSI/MSO VAT No" >${b(i.thead_vat_no)|n}</td>

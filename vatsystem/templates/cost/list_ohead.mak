...
<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" >
 	<li  class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active" ><a href="#tabs-0">CST</a></li>
</ul>
<div id="tabs-0" class="ui-tabs-panel ui-widget-content ui-corner-bottom" >
    <div class="none" id="vatDialog">
        <form action="/cost/update_all_ohead_vat_info" method="post" id="form2">
    ...
    <form action="/cost/export_all_thead" mehotd="post" id="form3">
        <input type="hidden" name="ids" id="ids3"/>
    </form>
    <form action="/cost/update_all_ohead_status" method="post" id="form1">
        <input type="hidden" name="ids" id="ids1"/>
        <input type="hidden" name="status" id="_status"/>
        <input type="submit" style="display:none">
    	<div class="box2">
        <div class="title1"><div class="toggle_down"></div>Search CST Result</div>
        <div class="box4">
                ...
                <tbody>
                   % for i in collections:
                    <tr id="tr1_${i.id}">
                        ...
                        <td title="Ref"><a href="javascript:viewOhead('${i.id}', '${i.ref}')">${b(i.ref)|n}</a></td>
                        <td title="MSI/MSO Ref" ><a href="javascript:viewThead('${i.thead_id}', '${i.thead_ref}')">${i.thead_ref}</a>&nbsp;</td>
